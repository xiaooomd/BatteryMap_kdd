"""Use all datasets from li_results for PSO hyperparameter optimization.

Scheme A implementation: Merge all datasets as the training set to find a universal set of optimal hyperparameters.

Example:
    # Use Autoformer model, 20 particles, 50 iterations
    python run_pso_li_results_all.py --model Autoformer --n_particles 20 --n_iterations 50

    # Use MLP model, quick test
    python run_pso_li_results_all.py --model MLP --n_particles 10 --n_iterations 20 --train_epochs 30
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='PSO optimization for all li_results datasets')
...
def main():
    ...
    config = {
        ...
        'feature_type': 'extracted_features',  # CSV feature mode
        'root_path': './dataset/li_results',  # Path to li_results data
    ...
    # Build command
    cmd = [sys.executable, 'hyperparameter_optimization.py']

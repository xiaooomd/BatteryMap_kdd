...
import datetime
import joblib
from utils.tools import del_files, EarlyStopping, adjust_learning_rate, load_content, vali_baseline, set_seed
...
for ii in range(args.itr):
    ...
    train_data, train_loader = data_provider_func(
        args, 'train', tokenizer=None, sample_weighted=args.weighted_sampling)

...
import datetime
import joblib
from utils.tools import del_files, EarlyStopping, adjust_learning_rate, load_content, set_seed
...
for ii in range(args.itr):
    ...
    test_data, test_loader = data_provider_func(
        args, 'test', use_id=True, tokenizer=tokenizer, 
        label_scaler=label_scaler, eval_cycle_min=eval_cycle_min, 
        eval_cycle_max=eval_cycle_max, life_class_scaler=life_class_scaler)

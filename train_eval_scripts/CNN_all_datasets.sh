#!/bin/bash
# Batch train CNN on all small datasets
...
master_port=29502  # Specify a valid port
num_process=2
batch_size=4
seq_len=1
...
do
    ...
    checkpoints=./checkpoints/CNN_${dataset}_$(date +%Y%m%d_%H%M%S)
